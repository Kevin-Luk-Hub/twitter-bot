...
PROVINCE_COUNTRY = ['Abruzzo, Italy',
                    'Acre, Brazil',
                    ...
                    'Jewish Autonomous Okrug, Russia',
                    'Jharkhand, India',
                    'Jiangsu, China',
                    'Jiangxi, China',
                    'Jilin, China',
